...
Residence is [defined](https://manoa.hawaii.edu/graduate/residency-program-requirement/) by the Graduate Division as a classified graduate student who is enrolled at UHM. (This is distinct from residency for tuition purposes.)
...
Students are expected to make timely progress toward the degree. This includes maintaining your GPA, meeting required degree [milestones](#phdprogram), and adhering to [normative times](#time) for degree completion. Failure to meet these expectation can lead to dismissal from the program.
