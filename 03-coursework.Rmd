...
4.  a brief description of the final product(s) of the course (e.g., QP draft, dissertation proposal draft, etc.)
5.  number of credits (maximum 6)

It is especially important that a Directed Reading course have a defined outcome or product, such as a QP or dissertation proposal/prospectus (point \#4 above). <span style="color:red;">Failure to achieve this outcome will result in an Incomplete or failing grade for the course.</span>
