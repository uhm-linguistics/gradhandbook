...
4. A data archiving plan (see ‘Archiving Fieldwork Data in Dissertations’)
5. evidence that permission has been received from the Institutional Review Board (IRB) to carry out research involving human subjects (if called for), and
...
- Must include _University Representative_, a member of the university's [Graduate Faculty](http://manoa.hawaii.edu/graduate/content/select-committee-member) who is neither a member of the Department of Linguistics nor a member of the department's Cooperating Faculty. 
